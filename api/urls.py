...
urlpatterns = [
    ...
    path('users/delete/<int:user_id>/', views.DeleteUserView.as_view(), name='delete-user'),


    path('attendance/delete/<int:attendance_id>/', views.DeleteAttendanceView.as_view(), name='delete-attendance'),
